...
const user_model_1 = require("./models/user.model"); // Asegúrate de tener la ruta correcta
const petpost_model_1 = require("./models/petpost.model"); // Ya lo tienes importado
/**
...
class PostgresDatabase {
    ...
    constructor(options) {
        this.datasource = new typeorm_1.DataSource({
            ...
            synchronize: true,
            entities: [petpost_model_1.PetPost, user_model_1.User],
            ssl: {
